...
const EFStrategywise: React.FC<PnlTablesProps> = ({ selectedFilters }) => {
  ...
  const [orderBy, setOrderBy] = useState<keyof DealTypeRow>('deal_type');
