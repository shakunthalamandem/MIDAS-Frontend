...
interface SentimentAgentTabProps {
  ticker?: string;
}
...
const SentimentAgentTab: React.FC<SentimentAgentTabProps> = ({ ticker }) => {
    ...
    const fetchSentimentData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/api/get_us_sentiment_analysis/`,
          {
            method: "POST",
            headers: {
...
export default SentimentAgentTab;
