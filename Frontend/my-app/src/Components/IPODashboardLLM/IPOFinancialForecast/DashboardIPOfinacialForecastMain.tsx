...
interface DashboardIPOfinacialForecastMainProps {
  defaultTicker?: string;
}

const DashboardIPOfinacialForecastMain: React.FC<
  DashboardIPOfinacialForecastMainProps
> = ({ defaultTicker = "" }) => {
...
export default DashboardIPOfinacialForecastMain;
