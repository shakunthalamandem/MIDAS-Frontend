          ...
          <TableBody>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Safety and Liquidity Check Max Size</strong>
              </TableCell>
              <TableCell>{data.safety_and_liquidity_check_max_size}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Shares Left to Go to Expected Allocation</strong>
              </TableCell>
              <TableCell>
                {data.shares_left_to_go_to_expected_allocation}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
              ...
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.current_price}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}><strong>Percent Change from Offer</strong></TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.percent_change_from_offer}</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
