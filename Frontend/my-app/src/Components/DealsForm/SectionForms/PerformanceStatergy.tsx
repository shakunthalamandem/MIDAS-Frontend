...
>
        <Table size="small" aria-label="performance strategy table">
          ...
          <TableBody>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Percent Change on Day</strong></TableCell>
              <TableCell>{data.percent_change_on_day}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Percent Change Last 7 Days</strong></TableCell>
              <TableCell>{data.percent_change_last_7_days}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>52 Week High</strong></TableCell>
              <TableCell>{data["52_week_high"]}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Percent Below 52 Week High</strong></TableCell>
              <TableCell>{data.percent_below_52_week_high}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Sector Stats (Last 30 Days) Performance</strong></TableCell>
              <TableCell>{data.sector_stats_l30d_performance}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Sector Stats Correlation</strong></TableCell>
              <TableCell>{data.sector_stats_correlation}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>3M ADTV (EU) USD</strong></TableCell>
              <TableCell>{data["3m_adtv_eu_line"].usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>3M ADTV (EU) Shares</strong></TableCell>
              <TableCell>{data["3m_adtv_eu_line"].shares}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>3M ADTV (Local) USD</strong></TableCell>
              <TableCell>{data["3m_adtv_local_line"].usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>3M ADTV (Local) Shares</strong></TableCell>
              <TableCell>{data["3m_adtv_local_line"].shares}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Beta (SMI)</strong></TableCell>
              <TableCell>{data.beta_smi}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Beta (SX5E)</strong></TableCell>
              <TableCell>{data.beta_sx5e}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>1 Sigma Block Trading Days (12M)</strong></TableCell>
              <TableCell>{data["1_sigma_block_trading_days_l12m"]}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>3M Volatility</strong></TableCell>
              <TableCell>{data["3m_volatility"]}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>RSI (14D)</strong></TableCell>
              <TableCell>{data.rsi_14d}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>RSI (30D)</strong></TableCell>
              <TableCell>{data.rsi_30d}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>DMI (14D)</strong></TableCell>
