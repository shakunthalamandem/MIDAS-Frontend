...
>
        <Table size="small" aria-label="participation details table">
          ...
          <TableBody>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Allocation Amount (USD)</strong></TableCell>
              <TableCell>{data.allocation.amount_usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Allocation Shares</strong></TableCell>
              <TableCell>{data.allocation.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Deal Percentage (Allocation)</strong></TableCell>
              <TableCell>{data.allocation.deal_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Fill Percentage</strong></TableCell>
              <TableCell>{data.allocation.fill_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Days to Allocate</strong></TableCell>
              <TableCell>{data.allocation.days}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Bookrunner Bank</strong></TableCell>
              <TableCell>{data.b_d_bank}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Final Indication Amount (USD)</strong></TableCell>
              <TableCell>{data.final_indication.amount_usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Final Indication Shares</strong></TableCell>
              <TableCell>{data.final_indication.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Final Indication Deal Percentage</strong></TableCell>
              <TableCell>{data.final_indication.deal_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Final Indication Days</strong></TableCell>
              <TableCell>{data.final_indication.days}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Deal Size Amount (USD)</strong></TableCell>
              <TableCell>{data.deal_size.amount_usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Deal Size Shares</strong></TableCell>
              <TableCell>{data.deal_size.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Company Percentage</strong></TableCell>
              <TableCell>{data.deal_size.company_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Deal Size Days</strong></TableCell>
              <TableCell>{data.deal_size.days}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Price (Local Currency)</strong></TableCell>
              <TableCell>{data.price_local.value}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Discount Percentage</strong></TableCell>
              <TableCell>{data.price_local.discount_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Last Close Price</strong></TableCell>
              <TableCell>{data.price_local.last_close}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Initial Range</strong></TableCell>
              <TableCell>{data.initial_range}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Deal Colour</strong></TableCell>
              <TableCell>{data.deal_colour}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Institutional Allocation (%)</strong></TableCell>
              <TableCell>{data.allocation_layout.institutional}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Retail Allocation (%)</strong></TableCell>
              <TableCell>{data.allocation_layout.retail}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Long Only Allocation (%)</strong></TableCell>
              <TableCell>{data.allocation_layout.long_only}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Hedge Funds Allocation (%)</strong></TableCell>
            ...
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Top 10 Allocation Concentration (%)</strong></TableCell>
            ...
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Aftermarket Strategy</strong></TableCell>
              <TableCell>{data.aftermarket.strategy}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Target Price (Local)</strong></TableCell>
              <TableCell>{data.aftermarket.target_price_local.value}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Target Price % Above Issue</strong></TableCell>
              <TableCell>{data.aftermarket.target_price_local.percentage_above_issue}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Stop Price (Local)</strong></TableCell>
              <TableCell>{data.aftermarket.stop_price_local.value}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{color:'#4d4d4d'}}><strong>Stop Price % Below Issue</strong></TableCell>
