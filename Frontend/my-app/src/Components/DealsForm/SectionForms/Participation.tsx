        ...
        <Table size="small" aria-label="participation details table">
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"violet"}}>{data.allocation.amount_usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Allocation Shares</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.allocation.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Deal Percentage (Allocation)</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.allocation.deal_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Fill Percentage</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.allocation.fill_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Days to Allocate</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.allocation.days}</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"violet"}}>{data.final_indication.amount_usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Final Indication Shares</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.final_indication.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Final Indication Deal Percentage</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.final_indication.deal_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Final Indication Days</strong></TableCell>
              <TableCell sx={{bgcolor:"violet"}}>{data.final_indication.days}</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"red"}}>{data.deal_size.shares}</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"yellow"}}>{data.price_local.discount_percentage}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Last Close Price</strong></TableCell>
              <TableCell sx={{bgcolor:"yellow"}}>{data.price_local.last_close}</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell  sx={{bgcolor:"cyan"}}>{data.deal_colour}</TableCell>
            </TableRow>

            <TableRow>
              <TableCell><strong>Institutional Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.institutional}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Retail Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.retail}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Long Only Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.long_only}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Hedge Funds Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.hedge_funds}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>Local Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.local}%</TableCell>
            </TableRow>
            <TableRow>
              <TableCell><strong>International Allocation (%)</strong></TableCell>
              <TableCell sx={{bgcolor:"cyan"}}>{data.allocation_layout.international}%</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell  sx={{bgcolor:"cyan"}}>{data.aftermarket.order ? 'Yes' : 'No'}</TableCell>
            </TableRow>
            <TableRow>
