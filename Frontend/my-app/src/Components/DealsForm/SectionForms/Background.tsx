        ...
        <Table size="small" aria-label="background data table">
          ...
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"#abf5f5"}}>{data.index_fund_participation.join(", ")}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Recent Earnings Estimate Revision</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.recent_earnings_estimate_revision}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Recent Positive News</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.recent_positive_news}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
            ...
            <TableRow>
              ...
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.short_interest.shares}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Short Interest (Dollar Amount)</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.short_interest.dollar_amount}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Short Interest (Percentage of Deal)</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.short_interest.percentage_of_deal}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Shares Outstanding Pre-Deal</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.shares_outstanding_pre_deal}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
                <strong>Market Cap Pre-Deal (USD)</strong>
              </TableCell>
              <TableCell sx={{bgcolor:"#b7cdf7"}}>{data.market_cap_pre_deal.usd}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}><strong>Market Cap Pre-Deal (CHF)</strong></TableCell>
              <TableCell sx={{ bgcolor:"#b7cdf7"}}>{data.market_cap_pre_deal.chf}</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell sx={{ bgcolor:"#b7cdf7"}}>{data.next_results_date}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: "#4d4d4d" }}>
