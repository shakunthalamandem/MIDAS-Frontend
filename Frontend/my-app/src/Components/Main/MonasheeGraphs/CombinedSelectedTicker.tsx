...
import {
  ...
  formatNumber,
  SelectedTickerProps,
} from "./tickerUtils"; // Adjust path as needed
    ...
    >
      <Grid container spacing={3}>
              ...
              {data.dealogic_data.data.map((deal, idx) => (
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ color: "#0073E6" }}>{ticker || "N/A"}</span>{" "}
                    on{" "}
                        ...
                        <Table size="small" aria-label="Dealogic Left Table">
                          <TableBody>
                            {[
                              ...
                              {
                                label: "Region",
                                value: deal.broad_region || "N/A",
                              },
                              {
                                label: "Deal Type",
                                value: deal.deal_type || "N/A",
                              },
                              {
                                label: "Deal Size",
                                value:
                            ...
                            {[
                              {
                                label: "Issue / Price",
                                value:
                                  formatNumber(deal.issue_offer_price) || "N/A",
                              },
                              {
                                ...
                                value:
                                  ...
                                  deal.t_plus_1d_return !== null ? (
                                    ...
                                    >
                                      {deal.t_plus_1d_return < 0 ? "-" : ""}
                                      {Math.abs(deal.t_plus_1d_return).toFixed(
                                        2
                                      )}
                                      %
                                      {deal.t_plus_1d_return < 0 ? (
                              ...
                              },
                              {
                                ...
                                value:
                                  ...
                                  deal.t1d_excess_return !== null ? (
                                    ...
                                    >
                                      {deal.t1d_excess_return < 0 ? "-" : ""}
                                      {Math.abs(deal.t1d_excess_return).toFixed(
                                        2
                                      )}
                                      %
                                      {deal.t1d_excess_return < 0 ? (
                              ...
                              },
                              {
                                ...
                                value:
                                  ...
                                  deal.t_plus_1m_returns !== null ? (
                                    ...
                                    >
                                      {deal.t_plus_1m_returns < 0 ? "-" : ""}
                                      {Math.abs(deal.t_plus_1m_returns).toFixed(
                                        2
                                      )}
                                      %
                                      {deal.t_plus_1m_returns < 0 ? (
        ...
        <Grid item xs={12} md={6}>
          ...
          {Array.isArray(data.mdd_data.data) &&
          data.mdd_data.data.length > 0 ? (
            <>
              <Typography
                variant="h6"
                gutterBottom
              ...
              >
                ...
                <span style={{ color: "#ff6005", fontStyle: "italic" }}>
                  {ticker} - {data.mdd_data.data.length} deals
                </span>
              </Typography>
                          ...
                          <TableBody>
                            {[
                              ...
                              },
                              {
                                ...
                                value: item.issue_offer_price || "N/A",
                              },
                              {
                                label: "Deal Captain",
                          ...
                          <TableBody>
                            {[
                              ...
                              },
                              {
                                label: "Primary %",
                                value:
                                  item.percentage_primary !== undefined &&
                                  item.percentage_primary !== null
                              ...
                              },
                              {
                                ...
                                value: (
                                  <ArrowValue value={item.allocation_ioi} />
                                ),
                              },
                              {
                                label: "Average Hold Period",
                                value:
                                  item.average_hold_period !== undefined &&
                                  item.average_hold_period !== null
                              ...
                              },
                              {
                                ...
                                value:
                                  item.total_committed_capital !== undefined &&
                              ...
                              },
                              {
                                ...
                                value:
                                  ...
                                  item.t1m_return_from_bloomberg !== null ? (
                                    ...
                                    >
                                      {item.t1m_return_from_bloomberg.toFixed(
                                        2
                                      )}
                                      %
                                      {item.t1m_return_from_bloomberg > 0 ? (
