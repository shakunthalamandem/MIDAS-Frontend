...
const InsightsMain = () => {
  const insights: InsightCardProps[] = [
  {
    ...
    "change": "+40% YoY",
    "status": "up",
    "comment": "Increase driven by stronger FO issuance and U.S. pipeline recovery."
  },
  {
    ...
    "change": "–12% QoQ",
    "status": "down",
    "comment": "Seasonal slowdown and absence of mega-deals in Q2 weighed on volumes."
  },
  {
  ...
  },
  {
    ...
    "change": "+3% YoY",
    "status": "up",
    "comment": "Improved IRR returns thanks to selective pricing and strong demand."
  },
  {
  ...
  },
  {
    ...
    "change": "down",
    "status": "down",
    "comment": "Underperformance despite strong IPO volume; exits remain muted."
  },
  {
  ...
  },
  {
    ...
    "change": "down",
    "status": "down",
    "comment": "FO segment underperformance in US despite highest capital allocated."
  },
  {
  ...
  },
  {
    ...
    "change": "down",
    "status": "down",
    "comment": "Actual IPO PnL trailed model due to later‐than‐expected exit timing."
  },
  {
    ...
    "change": "down",
    "status": "down",
    "comment": "FO PnL underperformed model forecasts, driven by mix and timing."
  }
];

  return (
    <Box sx={{ px: 2, py: 1 }}>
      <Typography variant="h5" fontWeight="bold" gutterBottom color="#FFFFFF" align="center">
        AI Market Insights Summary – 2025 YTD
      </Typography>
