...
interface NewDashboardTradingWidgetProps {
  ticker: string;
}

const NewDashboardTradingWidget: React.FC<NewDashboardTradingWidgetProps> = ({ ticker }) => {
...
export default memo(NewDashboardTradingWidget);
