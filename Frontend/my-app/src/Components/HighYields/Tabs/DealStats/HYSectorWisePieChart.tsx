...
interface HYSectorWisePieChartProps {
  data: Record<string, any>;
  selectedMetric: string;
}

const HYSectorWisePieChart: React.FC<HYSectorWisePieChartProps> = ({ data, selectedMetric }) => {
...
export default HYSectorWisePieChart;
