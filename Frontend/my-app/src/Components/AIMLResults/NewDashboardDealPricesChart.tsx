...
export interface NewDashboardDealPricesChartProps {
...
const NewDashboardDealPricesChart: React.FC<NewDashboardDealPricesChartProps> = ({
  deal,
  ticker: tickerProp,
...
export default NewDashboardDealPricesChart;
