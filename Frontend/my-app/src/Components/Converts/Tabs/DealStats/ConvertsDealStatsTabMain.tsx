...
interface ConvertsDealStatsTabMainProps {
  selectedFilters: Record<string, string | number | (string | number)[]>; 
  handleReset: () => void;
}

const ConvertsDealStatsTabMain: React.FC<ConvertsDealStatsTabMainProps> = ({
