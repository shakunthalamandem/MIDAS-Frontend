...
const fetchIpoTickers = async (
  ...
  const listingStatus: "pre-listing" | "post-listing" = operation === "Issued" ? "post-listing" : "pre-listing";
  return rows
    ...
    const loadTickers = async () => {
      ...
      try {
        ...
        const prepared = deals.map((deal) => ({
          ...deal,
          prompt: buildPrompt(deal.ticker, deal.deal_type, deal.issuer_name, deal.region, deal.listing_status),
