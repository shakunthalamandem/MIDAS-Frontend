        ...
        <Stack spacing={1.25}>
          ...
          <Box>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ mt: 0.75, display: "block" }}>
              Prob.{" "}
              <Typography component="span" variant="caption" fontWeight={800} color="text.primary">
...
export function MarketSentiment({ oneWeek, oneMonth }: { oneWeek: string; oneMonth: string }) {
  return (
...
export function AIMLPredictions({ data }: { data: DealRecommendationResponse }) {
  return (
