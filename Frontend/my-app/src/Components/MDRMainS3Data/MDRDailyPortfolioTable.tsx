                    ...
                    <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Button
                            ...
                            sx={{
                                minWidth: 100,
                                fontWeight: 600,
                                color: '#002060',  // Set the text color
                                borderColor: '#002060',  // Set the border color to match the text
                                '&:hover': {
                                    borderColor: '#001540',  // Darker border color on hover (optional)
                                    color: '#001540',  // Darker text color on hover (optional)
                                },
                            }}
                        >
                            RESET
